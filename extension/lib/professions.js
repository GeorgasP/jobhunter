 ...
 */
/* Οι ελληνικές ρίζες πιάνουν τα «Ζητείται φυσικοθεραπευτής»· οι greeklish
   πιάνουν τα slug των ελληνικών πινάκων («fysikotherapeftis-athina»). */
export const ALIASES = {
  "Physiotherapist": ["φυσικοθεραπευτ", "φυσιοθεραπευτ", "φυσικοθεραπε", "fysikotherape", "fysiotherape", "physiothera"],
  "Occupational Therapist": ["εργοθεραπευτ", "ergotherape"],
  "Speech and Language Therapist": ["λογοθεραπευτ", "logotherape"],
  "Registered Nurse": ["νοσηλευτ", "nosileft"],
  "Midwife": ["μαιευτ", "μαία", "maieft"],
  "Psychologist": ["ψυχολόγ", "psycholog", "psicholog"],
  "Psychotherapist": ["ψυχοθεραπευτ", "psychotherape"],
  "Dentist": ["οδοντίατρ", "odontiatr"],
  "Pharmacist": ["φαρμακοποι", "farmakopoi"],
  "Dietitian": ["διαιτολόγ", "diaitolog"],
  "Nutritionist": ["διατροφολόγ", "diatrofolog"],
  "Personal Trainer": ["γυμναστ", "personal trainer", "gymnast"],
  "Veterinarian": ["κτηνίατρ", "ktiniatr"],
  "Teacher": ["εκπαιδευτικ", "δάσκαλ", "καθηγητ", "ekpaideftik", "daskal", "kathigit"],
  "Chef": ["μάγειρ", "σεφ", "mageir", "sef"],
  "Waiter": ["σερβιτόρ", "servitor"],
  "Bartender": ["μπάρμαν", "barman"],
  "Driver": ["οδηγ", "odig"],
  "Electrician": ["ηλεκτρολόγ", "ilektrolog"],
  "Plumber": ["υδραυλικ", "ydravlik", "idravlik"],
  "Accountant": ["λογιστ", "logist"],
  "Receptionist": ["ρεσεψιονίστ", "υποδοχ", "ypodoch", "resepsionist"],
